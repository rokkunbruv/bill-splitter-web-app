    ...
    <Router>
      <Container maxWidth="lg" borderRadius='10'>
        {/* <AppBar 
          position='fixed' 
          color='inherit' 
          sx={{ backgroundColor: '#C8C7E0', borderRadius: 0, margin: '0', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: '60%'}}>
            <Typography component={Link} to="/" align='center' sx={{ color: 'rgba(7, 15, 43, 1)', textDecoration: 'none', fontWeight: '550', fontSize: '2.5rem', letterSpacing: '0.02em' }} >
              BillSplit
            </Typography>
            {/* add notif icon - maka navigate to notif page */}
        {/* </AppBar> */}
        <Box sx={{ pb: 7, margin:'15% 0 10% 0'}}>
          <Routes>
